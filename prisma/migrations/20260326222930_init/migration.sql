-- CreateEnum
CREATE TYPE "InstanceStatus" AS ENUM ('pending', 'provisioning', 'active', 'failed', 'cancelled');
...
-- CreateIndex
CREATE UNIQUE INDEX "Instance_stripeSubId_key" ON "Instance"("stripeSubId");
